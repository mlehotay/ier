...
* novel experiences feel long
* routine intervals feel short
* crises feel expanded
* boredom may feel slow while occurring but brief in retrospect
* narrative pacing alters perceived length
* memory of an interval may differ from how it felt when lived

These are often explained using:

* internal clocks
* accumulation of time units
* counting of events
* attention-based timing mechanisms

Under Informational Experiential Realism, such explanations are structurally unavailable.

IER does not permit:

* internal time variables
* stored durations
* event counting as a temporal measure
* traversal along a timeline
...
* how much deformation organizes an interval
* how heavily structural change is distributed across it

Higher density does not mean more activity.
...
* articulation into event-scale structure
* integration across envelopes

Well-organized deformation may:

* compress experience
* structure continuity
* produce stable temporal form

Disorganized deformation may:
...
Only deformation that is:

* propagated
* available for re-entry
* structurally integrated into ongoing or reconstructed organization

contributes to experienced duration.
...
* reshapes future admissibility
* enables persistence across intervals
...
* which deformation becomes experientially consequential
* which deformation participates in reconstruction
* which deformation shapes duration
...
* influences binding
* affects which collapses become event-scale
...
* integration-envelope coherence
* ongoing propagation
* salience loading
...
* little deformation persists
* registration is weak
* reconstruction is sparse
...
* compression does not necessarily mean “short”
* expansion does not necessarily mean “long” in retrospective terms
