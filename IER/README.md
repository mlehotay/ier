...
* [`IER-dont-panic.md`](./IER-dont-panic.md) — Reader-facing reassurance and scope clarification
...
* [`IER-psychosis.md`](./IER-psychosis.md) — Pathological regimes within intact subjects
...
* [`IER-gut.md`](./IER-gut.md) — Enteric system participation
...
Confusion, discomfort, or disagreement are expected consequences of a strong framework — not reader error.
