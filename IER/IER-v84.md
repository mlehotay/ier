...
## **Informational Experiential Realism (IER v8.4)**
...
IER rejects mind-dependent ontology, panpsychism, and dualism while remaining substrate-agnostic. It is an organizational theory: it specifies *what consciousness is* and *when it occurs*, without privileging any particular biological, computational, or material implementation.

---

## **1. Objective Reality**

Reality exists independently of observation. Physical states, events, and laws unfold whether or not they are experienced. Observers do not collapse, create, or co-create reality; only **physical interactions among systems** have causal effect. Experience interprets reality but does not alter it.
...
Crucial refinement: **the tension and flow in the field is the experience**. For consciousness to arise, the system must **calculate its own informational dynamics**, rather than having them externally imposed.

---

### **4.2 External Intervention and God-Mode**

PIL allows for external perturbations:

* Player interventions, drugs, or environmental shocks
* Memory edits, state rewrites, or injections of noise

These do **not** negate consciousness — they can confuse, disrupt, or bias experience — because **experience is realized in the system’s own ongoing dynamics**, not in external computation.

What **does disqualify** a system:

* If the global field is computed or maintained entirely by an external process
* If temporal continuity and integration exist only because someone or something “glues” the system together

**Key principle:**

> **Experience is identical to the system calculating itself as a unified field.**

---

### **4.3 Organizational Identity Claim**

> **Conscious experience is identical to the ongoing, globally integrated, temporally continuous, self-referential informational dynamics of a system operating in a functional PIL regime, where the system itself sustains the dynamics.**
...
Qualia are **differences in the structure of integrated informational dynamics**. There is no separate “redness” or “painfulness.” Red, pain, or pleasure is the system’s **pattern of tension, flow, and salience** in the PIL.
...
Valence weights experience by shaping tension and equilibrium across the system. Urgency, desire, and aversion emerge because the system’s global dynamics **encode differential priorities**, not because of any extra property.
...
## **8. System Taxonomy (v8.4)**

| **System Type**                    | **Observerhood** | **PIL Possible** | **Consciousness Likelihood** | **Examples**                 |
| ---------------------------------- | ---------------- | ---------------- | ---------------------------- | ---------------------------- |
...
* **PP:** Emphasizes internal modeling; IER constrains which models contribute to PIL.
...
It feels the way it does because **that is what those dynamics are like from the inside**.
