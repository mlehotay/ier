...
## **2. Identity Commitments Unpacked**

IER identifies experience with the operation of a physical system as a
**Unified Experiential Field (UEF)**.

From the Specification, a UEF necessarily involves:

1. **Global intrinsic constraint**
   Admissible future trajectories are defined at the system level and cannot be factored into independently satisfiable parts.

2. **Internal bearing of constraint**
...
* **Localization**
  Constraint can be confined to a proper subsystem without reorganizing the system as a whole.

* **Deferral**
  Constraint can be postponed indefinitely without accumulating unavoidable system-level pressure.

* **External resolution**
  Constraint can be offloaded, buffered, or absorbed by dynamics outside the system boundary.
...
* some subsystem can bear and resolve it
* the rest of the system need not participate
* global reorganization is unnecessary

In such a system:

* admissible futures are not constrained at the system level
* no single globally binding constraint-defined “now” exists
* temporal continuity is not shared across the entire system

But a **Unified Experiential Field** requires:

* a single globally binding regime of intrinsic constraint
...
* alternatives remain open without internal cost
* collapse of possibilities is not borne by the system
* no intrinsic inevitability is generated
...
> **If constraint is indefinitely deferrable, experience is impossible by identity.**
...
* its cost is not borne by the system
...
## **7. Slack Guarantees Identity Failure**

Informational slack exists **iff** at least one of the following holds:

* constraint can be localized
...
| ------------------- | ------------------------------------- |
| Localization        | No globally binding constraint regime |
...
## **9. No Gradients, No Borderline Cases**

This argument introduces:

* no degrees of experience
...
* sustains unavoidable, globally binding intrinsic constraint
  **or**
* it does not

If it does not, experience is absent.
