...
## Role of a Dynamics Document in IER
...
## Experiential Regimes and Attractor Structure

### Regimes in State Space
...
* insufficient constraint $\to$ under-integration $\to$ regime loss
* excessive constraint $\to$ overload $\to$ instability or collapse
...
## Failure Modes of Experiential Systems
...
Ethical commitments are fixed normatively in the IER specification and the canonical ethics framework derived from it.

This document introduces no independent ethical authority.
