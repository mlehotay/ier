...
It introduces no new IER primitives, criteria, diagnostics, thresholds, or authority. It uses an everyday social-ranking system to illustrate existing structural concepts: slack, saturation, coherence, propagation, and regime transition.

The example concerns a fictional running club called the Lonely Hearts Runners.

## The Club Rule

The Lonely Hearts Runners want their singlets to display playing cards.

The rule is simple:

- fastest runner: Ace of Hearts
- second fastest runner: King of Hearts
- third fastest runner: Queen of Hearts
- fourth fastest runner: Jack of Hearts
- and so on down the suit

At first, the system works smoothly.
...
In IER terms, slack is the capacity of a system to absorb, localize, defer, or otherwise resolve constraint without requiring full-system reorganization. In this example, unused Hearts provide spare symbolic capacity.

The club can preserve coherence because it still has room.
...
Queen of Hearts becomes Jack of Hearts
Jack of Hearts becomes Ten of Hearts
Ten of Hearts becomes Nine of Hearts
...
```
...
Now the thirteenth Heart is assigned.
...
If a fourteenth runner joins, the club faces a structural problem. Either it allows rank conflict, abandons uniqueness, or changes the organizing regime.
...
The new degree of freedom restores slack by creating additional structure for absorbing change.
...
A small symbolic system is asked to preserve unique distinctions under increasing pressure. At first, it has spare capacity. Then that capacity shrinks. Eventually it saturates. To avoid conflict, the system must reorganize.
...
Saturation produces rank conflict.

Introducing Diamonds adds a new degree of freedom.

The club preserves coherence by transitioning into a new symbolic regime.

In compressed form:

> A system with spare capacity can absorb local change. As slack disappears, local changes propagate globally. At saturation, coherence fails unless the system reorganizes by introducing a new dimension of admissible distinction.
