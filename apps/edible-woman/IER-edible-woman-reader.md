...
```mermaid
flowchart TD
    A["Socially prepared future"] --> B["Direct refusal remains unstable"]
    B --> C["Food and ordinary actions reorganize"]
    C --> D["Refusal transfers into consuming"]
    D --> E["The cake externalizes the relation"]
    E --> F["Direct refusal and disengagement"]
```
